 <ul class="breadcrumb breadcrumb__t"><a class="home" href="#">Home</a>  / Contact</ul>
		   <div class="content-top">
			   <form method="post" action="contact-post.html">
					<div class="to">
                     	<input type="text" class="text" value="" placeholder="Nama">
					 	<input type="text" class="text" value="" placeholder="Email" style="margin-left: 10px">
					</div>
					<div class="to">
                     	<input type="text" class="text" value="" placeholder="Telepon">
					 	<input type="text" class="text" value="" placeholder="Judul" style="margin-left: 10px">
					</div>
					<div class="text">
